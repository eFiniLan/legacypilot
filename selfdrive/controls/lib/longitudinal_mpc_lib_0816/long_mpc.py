...
if __name__ == '__main__':  # generating code
  ...
  from selfdrive.controls.lib.longitudinal_mpc_lib_0816.c_generated_code.acados_ocp_solver_pyx import AcadosOcpSolverCython  # pylint: disable=no-name-in-module, import-error
